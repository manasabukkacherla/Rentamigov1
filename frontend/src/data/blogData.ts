import type { BlogPostType } from "../types/type"
...
export const blogPosts: BlogPostType[] = [
  ...
  },
  {
    ...
    userHasLiked: false,
    excerpt:
      "Penthouses offer unparalleled views and amenities, but come with a premium price tag. We analyze if the investment is justified...",
  },
  {
    id: 3,
    title: "Urban Loft in Downtown District",
    content:
      "Live in the heart of the action with this stylish urban loft in the vibrant downtown district. This contemporary space features soaring ceilings, exposed brick walls, and industrial-inspired finishes that pay homage to the building's historic past. The open floor plan is bathed in natural light thanks to the large warehouse windows, creating a bright and airy atmosphere. The property has been thoughtfully renovated with high-quality materials and fixtures, including polished concrete floors, custom cabinetry, and designer lighting.",
    category: "Urban",
    coverImage:
  ...
  },
  {
    ...
    userHasLiked: false,
    excerpt:
      "Creative design solutions to transform your compact studio apartment into a functional and stylish home...",
  },
  {
    id: 6,
    title: "Historic Brownstone with Modern Updates",
    content:
      "Experience the perfect blend of historic charm and contemporary comfort in this beautifully renovated brownstone. Located in a historic district, this property showcases original architectural details such as crown moldings, hardwood floors, and a decorative fireplace. The renovation has thoughtfully integrated modern amenities while preserving the building's character and integrity. The kitchen features custom cabinetry, high-end appliances, and a marble island, while the bathrooms have been updated with luxury fixtures and finishes.",
    category: "Historic",
    coverImage:
    ...
    userHasLiked: false,
    excerpt:
      "Beyond the monthly rent, there are several expenses that renters should anticipate when budgeting for a house...",
  },
]
