  ...
  const formSections = [
    {
      ...
      content: (
        <>
          ...
          <OfficeSpaceType onOfficeTypeChange={handleOfficeTypeChange} />
    ...
    },
    {
      ...
      content: (
        <>
          <OfficeSpaceDetails onDetailsChange={handleOfficeDetailsChange} />
...
function handleOfficeTypeChange(type: string): void {
  throw new Error('Function not implemented.');
}
...
function handleOfficeDetailsChange(details: Record<string, any>): void {
  throw new Error('Function not implemented.');
}
