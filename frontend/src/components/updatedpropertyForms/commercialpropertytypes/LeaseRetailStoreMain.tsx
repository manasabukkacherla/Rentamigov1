...
const LeaseRetailStoreMain = () => {
      ...
      try {
        ...
        if (response.data && response.data.success) {
          ...
          const transformedData = {
            ...
            basicInformation: retailshop.basicInformation || {
              title: '',
              Type: [],
            ...
            retailStoreDetails: retailshop.retailStoreDetails || {
              location: '',
              anchorStores: false,
              footfallData: '',
              signageAllowed: false,
            ...
            propertyDetails: retailshop.propertyDetails || {
            ...
            leaseTerms: retailshop.leaseTerms || {
              leaseDetails: { 
                leaseAmount: { amount: 0, type: 'fixed', duration: 0, durationUnit: 'years' } 
              },
              tenureDetails: { 
                minimumTenure: 0, minimumUnit: 'years', maximumTenure: 0, maximumUnit: 'years', 
                lockInPeriod: 0, lockInUnit: 'years', noticePeriod: 0, noticePeriodUnit: 'months' 
              },
              ...
              availability: { 
                date: new Date(), availableImmediately: false, preferredSaleDuration: '', 
                noticePeriod: '', isPetsAllowed: false, operatingHours: false 
              }
            },
            contactInformation: retailshop.contactInformation || {
              name: '', email: '', phone: '', alternatePhone: '', bestTimeToContact: ''
            },
            media: retailshop.media || {
              photos: {
                exterior: [],
                interior: [],
                floorPlan: [],
          ...
          <div className="space-y-6">
            ...
            <MapLocation
              ...
              onLocationChange={(location) => setFormData(prev => ({ 
                ...prev, 
                basicInformation: { ...prev.basicInformation, location } 
              }))}
              onAddressChange={(address) => setFormData(prev => ({ 
                ...prev, 
                basicInformation: { ...prev.basicInformation, address } 
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      // Prepare data that matches backend schema exactly
      const submitData = {
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-black">
            {propertyId ? 'Edit Commercial Retail Store' : 'Lease Commercial Retail Store'}
          </h1>
        </div>
        <div className="mb-8">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200">
        <div className="max-w-5xl mx-auto px-4 py-4 flex justify-between">
          ...
          <button
            ...
            className="flex items-center px-6 py-2 rounded-lg bg-black text-white hover:bg-gray-800 transition-all duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
              <>
              ...
              <>
                {currentStep === steps.length - 1 ? (propertyId ? 'Update' : 'Submit') : 'Next'}
