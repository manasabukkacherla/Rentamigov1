...
import PlotPropertyFeatures from '../PlotPropertyFeatures';
...
interface SellPlotProps {
  onSubmit?: (formData: any) => void;
}

const SellPlot = ({ onSubmit }: SellPlotProps) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      component: (
        <>
          <PlotPropertyFeatures onFeaturesChange={(features) => setFormData(prev => ({ ...prev, plotFeatures: features }))} />
