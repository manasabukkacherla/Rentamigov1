  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-3 sm:p-4 lg:p-5">
      <div className="flex items-center mb-4 sm:mb-5">
        ...
        <h2 className="text-lg sm:text-xl lg:text-2xl font-bold">Statistics Overview</h2>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-5 mb-4 sm:mb-5">
        ...
        <div className="bg-gray-50 p-3 rounded-lg">
          ...
          <p className="text-xl sm:text-2xl font-bold mb-1">{stats.totalViews.toLocaleString()}</p>
          <p className="text-xs sm:text-sm text-green-600 flex items-center">
            <TrendingUp className="h-3 w-3 mr-1" />+{stats.viewsThisMonth.toLocaleString()} this month
          </p>
        </div>
        ...
        <div className="bg-gray-50 p-3 rounded-lg">
          ...
          <p className="text-xl sm:text-2xl font-bold mb-1">{stats.totalLikes.toLocaleString()}</p>
          <p className="text-xs sm:text-sm text-green-600 flex items-center">
            <TrendingUp className="h-3 w-3 mr-1" />+{stats.likesThisMonth.toLocaleString()} this month
          </p>
        </div>
        ...
        <div className="bg-gray-50 p-3 rounded-lg">
          ...
          <p className="text-xl sm:text-2xl font-bold mb-1">{stats.totalComments.toLocaleString()}</p>
          <p className="text-xs sm:text-sm text-green-600 flex items-center">
            <TrendingUp className="h-3 w-3 mr-1" />+{stats.commentsThisMonth.toLocaleString()} this month
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-50 p-3 rounded-lg">
        ...
        <div className="space-y-2">
          <div>
            ...
            <p className="font-medium text-sm truncate">{stats.mostViewedBlog}</p>
          </div>
          <div>
            <p className="text-xs sm:text-sm text-gray-600">Most Liked Blog</p>
            <p className="font-medium text-sm truncate">{stats.mostLikedBlog}</p>
          </div>
          <div>
            <p className="text-xs sm:text-sm text-gray-600">Most Commented Blog</p>
            <p className="font-medium text-sm truncate">{stats.mostCommentedBlog}</p>
          </div>
        </div>
      </div>
    </div>
