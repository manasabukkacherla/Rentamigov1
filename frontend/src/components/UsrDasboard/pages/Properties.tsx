    ...
    const fetchUserProperties = async () => {
      try {
        ...
        const [propertiesRes, imagesRes, commercialsRes] = await Promise.all([
          ...
          axios.get("/api/properties/property-commercials/user", {
            params: { userId },
          }),
        ]);
        ...
        const finalProperties = userProperties
          .map((property: any) => {
            ...
            return {
              ...
              imageUrl:
                image?.photos?.coverImage || "https://via.placeholder.com/300", // Fallback Image
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-left">
                          ...
                          <p
                            className={`text-xs ${
                              isSelected ? "text-current/70" : "text-black/60"
                            }`}
                          >
