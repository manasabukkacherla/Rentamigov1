...
const residentialSaleBuilderFloorSchema = new mongoose_1.default.Schema({
    propertyId: {
        type: String,
        required: false,
        unique: false,
...
const ResidentialSaleBuilderFloor = mongoose_1.default.model('ResidentialSaleBuilderFloor', residentialSaleBuilderFloorSchema);
exports.default = ResidentialSaleBuilderFloor;
