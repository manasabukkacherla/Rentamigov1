...
const residentialRentIndependentHouseSchema = new mongoose_1.default.Schema({
    propertyId: {
        type: String,
        required: false,
        unique: false,
...
const ResidentialRentIndependentHouse = mongoose_1.default.model('ResidentialRentIndependentHouse', residentialRentIndependentHouseSchema);
exports.default = ResidentialRentIndependentHouse;
