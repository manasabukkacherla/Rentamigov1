...
;
const ResidentailRentApartmentSchema = new mongoose_1.Schema({
...
const ResidentialRentApartment = mongoose_1.default.model('ResidentialRentApartment', ResidentailRentApartmentSchema);
exports.default = ResidentialRentApartment;
