...
import amenitiesRoutes from "./routes/newsocietyamenities"
import flatAmenitiesRoutes from "./routes/flatAmenities";
dotenv.config();
...
app.use("/api/societyamenities",amenitiesRoutes)
