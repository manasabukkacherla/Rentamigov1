...
import { residentialMediaUpload, processAndUploadResidentialMedia } from '../middleware/residentialMediaUploader';

const router = express.Router();

// Route for uploading media files
router.post('/upload', 
  residentialMediaUpload,
  processAndUploadResidentialMedia,
  (req, res) => {
    try {
      if (!req.mediaItems) {
