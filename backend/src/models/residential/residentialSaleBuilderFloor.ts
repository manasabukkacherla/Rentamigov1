...
const residentialSaleBuilderFloorSchema = new mongoose.Schema<IResidentialSaleBuilderFloor>({
  propertyId: {
    type: String,
    required: false,
    unique: false,
...
const ResidentialSaleBuilderFloor = mongoose.model('ResidentialSaleBuilderFloor', residentialSaleBuilderFloorSchema);

export default ResidentialSaleBuilderFloor;
