  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-1">Similar Properties</h2>
          <p className="text-gray-600 text-sm">Explore more properties in this area</p>
        </div>
      ...
      <div className="relative">
        <button
          onClick={() => scroll("left")}
          className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg rounded-full p-2 -ml-3 hover:bg-gray-50 transition-colors"
        ...
        <div
          ...
          className="flex overflow-x-auto snap-x snap-mandatory gap-5 scroll-smooth pb-4 px-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
        >
          {filteredProperties.map((property) => {
            ...
            return (
              ...
              >
                <div className="h-full bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 flex flex-col border border-gray-100">
                  <div className="relative">
                    ...
                    <div className="absolute top-3 left-3 flex items-center gap-1.5 px-2 py-1 bg-white/90 backdrop-blur-sm text-gray-900 text-xs font-medium shadow-sm rounded-lg">
                    ...
                    {property.featured && (
                      <div className="absolute top-0 left-0">
                        <div className="bg-gray-900 text-white py-1 px-6 rotate-[-45deg] translate-x-[-30%] translate-y-[40%] text-xs font-medium shadow-md">
                          Featured
                        </div>
                      </div>
                    )}
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-3 flex justify-between items-center bg-gradient-to-t from-black/70 via-black/40 to-transparent">
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-md hover:bg-gray-50 transition-colors"
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <button className="mt-auto w-full py-2.5 text-center text-white font-medium bg-gray-900 rounded-lg hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 shadow-sm text-sm">
        ...
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg rounded-full p-2 -mr-3 hover:bg-gray-50 transition-colors"
      ...
      <div className="flex justify-center mt-6">
        <button className="group flex items-center gap-2 px-5 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition-colors shadow-sm">
